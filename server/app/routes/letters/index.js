...
//         auth: {
//             user: env.smtp.user, // generated ethereal user
//             pass: env.smtp.pass // generated ethereal password
//         }
//     });
...
//end updates
// let header = `<div style="font-family: arial; font-size: 14px; color: #041e42; padding: 10px;">
...
//                     <img src="image/logo.png" alt="Sabic">
//                 </td>
//             </tr>
//         </table>
//         <p style="font-weight: bold; font-size: 14px; ">RE : L/C NO. xxxxxxxxxxxxxxxxxx DATED dd.mm.yyyy (SABIC Sales Contract Number xx/xxxxx)</p>
...
// let table = `
//             <li style="margin-bottom: 10px;">1. CLAUSE ${swift_code}: ${note}</li>`
